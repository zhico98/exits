...
export default function SnowBored() {
  ...
  const playCharacterSound = (characterIndex: number) => {
    ...
    switch (characterIndex) {
      case 0: // Skull Warrior
        audioSrc = "/barbarian-sound.mp3"
        break
      case 1: // Shadow Ninja
        audioSrc = "/ninja-sound.mp3"
        break
      case 2: // Ghost Spirit
        audioSrc = "/ghost-sound.mp3"
        break
      default:
        return
    }
  ...
  const playGameOverSound = () => {
    ...
    try {
      const audio = new Audio("/game-over-sound.mp3")
      audio.volume = 0.6
      audio.preload = "auto"
  ...
  if (showCharacterSelect) {
    return (
      ...
      >
        {/* Sol üst - About butonu */}
        <div className={`absolute ${isMobile ? "top-2 left-2" : "top-4 left-4"}`}>
          <Button
            variant="outline"
            className={`border-red-400 text-red-400 hover:bg-red-400 hover:text-black bg-black/80 ${isMobile ? "px-2 py-1 text-xs" : "px-4 py-2"}`}
        ...
        <div className={`absolute ${isMobile ? "top-2 right-2" : "top-4 right-4"} flex gap-1`}>
          <Button
            variant="outline"
            className={`border-red-400 text-red-400 hover:bg-red-400 hover:text-black bg-black/80 ${isMobile ? "px-2 py-1" : "px-3 py-2"}`}
            style={{ fontFamily: '"8-BIT WONDER", monospace', fontSize: isMobile ? "8px" : "10px" }}
            onClick={() => {
              playClickSound()
              window.open("https://x.com/exitlifedotfun", "_blank")
            }}
          >
            {isMobile ? "X" : "Twitter"}
          </Button>
          <Button
            ...
            onClick={() => {
              playClickSound()
              window.open("https://t.me/exitlifefun", "_blank")
            }}
          >
          ...
          >
            {isMobile ? "PF" : "Pump.fun"}
          </Button>
        </div>

        <h1
          className={`${isMobile ? "text-2xl" : "text-4xl"} font-bold mb-8 text-red-400`}
          style={{
        ...
        <div
          className={`bg-black/80 ${isMobile ? "p-4" : "p-8"} rounded-lg border-2 border-red-400 ${isMobile ? "w-full max-w-sm" : ""}`}
        >
          <h2
        ...
        {showAbout && !showStory && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
            <div
              className={`bg-black/90 ${isMobile ? "p-4 mx-2" : "p-8 mx-4"} rounded-lg border-4 border-red-400 ${isMobile ? "w-full max-w-sm" : "max-w-4xl w-full"} relative`}
            >
              <div className="bg-black/80 p-6 rounded-lg">
                <h2
                  className={`${isMobile ? "text-xl" : "text-3xl"} font-bold mb-6 text-red-400 text-center`}
                  style={{
                    fontFamily: '"8-BIT WONDER", monospace',
                ...
                <div className={`grid ${isMobile ? "grid-cols-1 gap-4" : "grid-cols-3 gap-6"} mb-8`}>
                  {IMAGES.CHARACTERS.map((character, index) => (
                    <div
                      key={index}
                      className={`${isMobile ? "p-3" : "p-4"} border-2 border-red-400 rounded cursor-pointer transition-all hover:border-red-300 hover:bg-red-400/10 bg-black/60`}
                      onClick={() => {
                        openStory(index)
                      }}
                    >
        ...
        {/* Story Notebook Modal - Mobile Optimized */}
        {showStory && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-2">
            <div className={`relative ${isMobile ? "w-full max-w-sm" : "max-w-7xl w-full mx-4"}`}>
              {isMobile ? (
                ...
                <div className="bg-black/90 p-4 rounded-lg border-4 border-red-400">
                  <h3
                    className="text-lg font-bold mb-4 text-red-400 text-center"
                    style={{
                      fontFamily: '"8-BIT WONDER", monospace',
                      textShadow: "2px 2px 0px #000000",
                    }}
                ...
                // Desktop Story View - Book Layout (unchanged)
                <div
        ...
        <div className="absolute bottom-4 left-0 right-0 text-center">
          ...
          >
            © 2025 EXITLIFE. All rights reserved
          </p>
        </div>
      </div>
    )
  ...
  return (
    ...
    >
      ...
      <h1
        className={`${isMobile ? "text-2xl" : "text-4xl"} font-bold mb-2 ${gameOver ? "text-red-600" : "text-red-400"}`}
        style={{
          fontFamily: '"8-BIT WONDER", monospace',
          textShadow: "1px 1px 0px #000000, -1px -1px 0px #000000, 1px -1px 0px #000000, -1px 1px 0px #000000",
          WebkitTextStroke: "0.5px #000000",
      ...
      >
        {gameOver ? "GAME OVER - YOU DIE" : "EXITLIFE"}
      </h1>
