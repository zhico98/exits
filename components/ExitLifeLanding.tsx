      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card className="bg-black/80 border-green-400">
            <CardContent className="p-6">
              <h3 className="text-green-400 text-xl mb-4" style={{ fontFamily: '"8-BIT WONDER", monospace' }}>
                🎮 Game Features
              </h3>
              <ul
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              ...
              style={{ fontFamily: '"8-BIT WONDER", monospace' }}
              onClick={() => window.open("https://x.com/exitlifedotfun", "_blank")}
            >
              🐦 Follow Us
            </Button>
            ...
            <Button
              ...
              style={{ fontFamily: '"8-BIT WONDER", monospace' }}
              onClick={() => window.open("https://t.me/exitlifefun", "_blank")}
            >
              💬 Telegram
            </Button>
          </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-white mb-4" style={{ fontFamily: '"8-BIT WONDER", monospace', fontSize: "12px" }}>
            "Life is about knowing when to exit. ExitLife teaches you the art of the perfect exit."
          </p>
          <div
            className="flex justify-center space-x-8 text-green-400"
